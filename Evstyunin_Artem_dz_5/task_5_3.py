...
my_list = ((tutor,klass) for tutor,klass in itertools.zip_longest(tutors,klasses))
while True:
    if len(tutors) == len(klasses) or len(tutors) != len(klasses):
        print(next(my_list))

# Выводит принт, пока не получит StopIteration
